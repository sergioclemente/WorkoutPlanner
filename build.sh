...
# Build JSX files
tsc --moduleResolution node --m commonjs --target ES5 --jsx react app/error_label.tsx app/user_settings.tsx app/number_input.tsx

browserify model.js ui.js index.js app/user_settings.js app/error_label.js app/number_input.js -o index.min.js
