...
var WorkoutView = (function (_super) {
    ...
    WorkoutView.prototype.renderCharts = function () {
        // Timeline chart
    ...
    WorkoutView.prototype.render = function () {
        return (React.createElement("div", null, React.createElement("h2", null, "Steps"), React.createElement("ul", null, this.renderWorkoutSteps()), React.createElement("div", {"id": "chartTimeline", "style": { height: "300px", width: "100%" }}), React.createElement("div", {"id": "chartZones", "style": { height: "200px", width: "100%" }}), React.createElement("h2", null, "Summary"), React.createElement("table", null, React.createElement("tbody", null, React.createElement("tr", null, React.createElement("td", null, "Metric"), React.createElement("td", null, "Value")), React.createElement("tr", null, React.createElement("td", null, "TSS"), React.createElement("td", null, this.state.tss)), React.createElement("tr", null, React.createElement("td", null, "Time"), React.createElement("td", null, this.state.time)), React.createElement("tr", null, React.createElement("td", null, "IF"), React.createElement("td", null, this.state.intensity)), this.renderPower())), "Workout Text:", React.createElement("div", null, this.state.workout_text)));
    };
    return WorkoutView;
})(React.Component);
