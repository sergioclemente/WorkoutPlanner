...
var WorkoutInput = (function (_super) {
    ...
    WorkoutInput.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", null, React.createElement("h1", null, " Workout Settings "), React.createElement("form", null, "Sport type:", React.createElement(select_1.default, {"ref": "sportType", "defaultValue": this.props.sport_type, "onChange": function (e) { return _this._onSportTypeChange(e); }}, React.createElement(select_option_1.default, {"value": Model.SportType.Bike}, "Bike"), React.createElement(select_option_1.default, {"value": Model.SportType.Run}, "Run")), React.createElement("br", null), "Unit:", React.createElement(select_1.default, {"ref": "unit", "defaultValue": this.props.output_unit, "onChange": function (e) { return _this._onUnitChanged(e); }}, React.createElement(select_option_1.default, {"value": Model.IntensityUnit.Watts}, "Watts"), React.createElement(select_option_1.default, {"value": Model.IntensityUnit.MinMi}, "min/mi"), React.createElement(select_option_1.default, {"value": Model.IntensityUnit.Mph}, "mi/h"), React.createElement(select_option_1.default, {"value": Model.IntensityUnit.MinKm}, "min/km"), React.createElement(select_option_1.default, {"value": Model.IntensityUnit.Kmh}, "km/h"), React.createElement(select_option_1.default, {"value": Model.IntensityUnit.IF}, "IF")), React.createElement("br", null), React.createElement("textarea", {"ref": "workout_text", "defaultValue": this.props.workout_text, "style": { height: "200px", width: "100%" }, "onChange": function (e) { return _this._onWorkoutTextChange(e); }}), React.createElement("br", null))));
    };
    return WorkoutInput;
})(React.Component);
