...
expect_eq_str("2 x (5' @ 235w, 2' @ 310w) - w/ 1' easy @ 205w", Model.WorkoutTextVisitor.getIntervalTitle(Model.IntervalParser.parse(of_run, "2[(5min, 75), (2min, 100), (1min, 65)]"), up, Model.SportType.Bike, Model.IntensityUnit.Watts));
